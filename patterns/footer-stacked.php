...
<p class="has-text-align-center has-small-font-size">&copy; 2023 <?php echo esc_html__( 'Your Company LLC', 'sycamore' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'sycamore' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
