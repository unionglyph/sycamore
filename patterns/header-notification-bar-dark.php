 ...
 * Slug: sycamore/header-notification-bar-dark
 * Categories: header
...
<p class="has-text-align-center has-x-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'With its minimal design and powerful feature set, Sycamore enables agencies to build stylish websites.', 'sycamore' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
...
<div class="wp-block-button has-custom-font-size" style="font-size:14px"><a class="wp-block-button__link wp-element-button" style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><?php echo esc_html__( 'Get Started', 'sycamore' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
