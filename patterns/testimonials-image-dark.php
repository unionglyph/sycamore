 ...
 * Slug: sycamore/testimonials-image-dark
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, Sycamore enables agencies to build cool websites.', 'sycamore' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_white_800x800.jpg'; ?>" alt="<?php echo esc_attr__( 'Testimonial Avatar', 'sycamore' ); ?>" class="wp-image-299" style="border-radius:50px" width="60" height="60"/></figure>
<!-- /wp:image -->
...
<p class="has-small-font-size"><strong><?php echo esc_html__( 'Allison Taylor', 'sycamore' ); ?></strong></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php echo esc_html__( 'Designer', 'sycamore' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"},"typography":{"lineHeight":"1.5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="line-height:1.5"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><strong><?php echo esc_html__( 'Anthony Breck', 'sycamore' ); ?></strong></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php echo esc_html__( 'Developer', 'sycamore' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"},"typography":{"lineHeight":"1.5"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="line-height:1.5"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><strong><?php echo esc_html__( 'Rebecca Jones', 'sycamore' ); ?></strong></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php echo esc_html__( 'Coach', 'sycamore' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
