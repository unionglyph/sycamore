 ...
 * Slug: sycamore/product-box-dark
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_white_800x800.jpg'; ?>" alt="<?php echo esc_attr__( 'Sycamore Theme Sample Image', 'sycamore' ); ?>" class="wp-image-6003"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Sycamore WordPress Theme', 'sycamore' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}}} -->
<p style="line-height:1.5"><?php echo esc_html__( 'The ultimate WordPress block theme for agencies and website builders.', 'sycamore' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--large)"><?php echo esc_html__( 'Buy Sycamore', 'sycamore' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
